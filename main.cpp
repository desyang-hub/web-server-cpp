...
struct HttpRequest {
    ...
    bool parse(const std::string& raw) {
        ...
        std::istringstream f(line); f >> method >> path >> protocol;
        is_complete = true; return true;
    }
};
...
int main() {
    ...
    if (bind(listen_fd, (struct sockaddr*)&server_addr, sizeof(server_addr)) < 0) { perror("bind"); return 1; }
